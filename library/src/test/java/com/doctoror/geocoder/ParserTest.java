...
public final class ParserTest {
    ...
    public void testEmptyString() throws Throwable {
        ...
        mException.expect(GeocoderException.class);
        Parser.parseJson(data, 20, true);
    }
    ...
    public void testEmptyResults() throws Throwable {
        ...
        final List<Address> result = Parser.parseJson(data, 20, true);
    ...
    public void testAllComponents() throws Throwable {
        ...
        assertEquals(34.235309, bounds.northeast.latitude, 0);
        assertEquals(-118.5534191, bounds.northeast.longitude, 0);
        assertEquals(34.179105, bounds.southwest.latitude, 0);
        assertEquals(-118.58832, bounds.southwest.longitude, 0);

        final Address.Viewport viewport = address.getViewport();
        assertNotNull(viewport);
        assertNotNull(viewport.northeast);
        assertNotNull(viewport.southwest);
        assertEquals(34.2316232, viewport.northeast.latitude, 0);
        assertEquals(-118.5390072, viewport.northeast.longitude, 0);
        assertEquals(34.1947148, viewport.southwest.latitude, 0);
        assertEquals(-118.6030368, viewport.southwest.longitude, 0);
        ...
        assertEquals(34.213171, location.latitude, 0);
        assertEquals(-118.571022, location.longitude, 0);
